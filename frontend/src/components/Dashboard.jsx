...
const Dashboard = () => {
  ...
  const cards = [
    ...
    // ✅ NEW: Concept Mastery Confidence
    {
      title: "Concept Mastery Confidence",
      route: "/agent/concept-mastery",
      emoji: "🧠"
    },
    {
      title: "Cognitive Load Analysis",
      route: "/agent/cognitive-load",
      emoji: "🧩"
    },
    { title: "Guessing & Overconfidence", route: "/agent/guessing-detection", emoji: "🎲" }
