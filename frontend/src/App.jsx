...
// import ExamReadiness from "./components/ExamReadiness";
// import PracticeQuestions from "./components/PracticeQuestions";
// import ConceptMasteryConfidence from "./components/ConceptMasteryConfidence";
...
//         {/* NEW: Concept Mastery Confidence Agent */}
//         <Route
//           path="/agent/concept-mastery"
//           element={<ConceptMasteryConfidence />}
//         />
...
import GuessingDetection from "./components/GuessingDetection";
  ...
  return (
    <Router>
      <Routes>
        ...
        />
        <Route
          path="/agent/cognitive-load"
          element={<CognitiveLoad />}
        />
        <Route
          path="/agent/guessing-detection"
          element={<GuessingDetection />}
        />
